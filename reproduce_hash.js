...
console.log("--- BRUTE FORCE HASH CHECK ---");
console.log(`Target Hash (from Screenshot): 76B444C859F375E2459090CBBF9C5066`);
...
for (const [name, secret] of Object.entries(secrets)) {
    ...
    if (finalHash === "76B444C859F375E2459090CBBF9C5066") {
